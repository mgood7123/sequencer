...
import smallville7123.sequencer.R;

public class MetronomeActivity extends Activity {
	
	private final short minBpm = 20;
	private final short maxBpm = 400;

	private short bpm = 40;
    ...
    UpdatingTextView currentBeat;

    void u() {
		if (metroTask != null) {
			currentBeat.setTextColor(metroTask.metronome.displayBeat == 1 ? Color.GREEN : Color.YELLOW);
			currentBeat.setText(
					metroTask.metronome.displayBeat +
							(metroTask.metronome.writing ? " writing beat" : "   wrote beat")
			);
		}
	}
    ...
    public void onCreate(Bundle savedInstanceState) {    	
        ...
        currentBeat = (UpdatingTextView) findViewById(R.id.currentBeat);
		currentBeat.addOnFirstDrawAction(() -> u());
		currentBeat.addOnDrawAction(() -> u());
