...
import static smallville7123.sequencer.sequencer.pfseq.PFSeq.LOG_EOL;
import static smallville7123.sequencer.sequencer.pfseq.PFSeq.LOG_TAG;
import static smallville7123.sequencer.sequencer.pfseq.PFSeq.MILLIS_PER_SECOND;
...
public class PFSeqConfig implements Serializable {
    ...
    private boolean validate() {
        ...
        if (getInt(TIMESTAMP_POLLING_DELAY_MILLIS) >= bufferSizeMillis) {
            ...
            _ints.put(TIMESTAMP_POLLING_DELAY_MILLIS, bufferSizeMillis);
        }
        if (getInt(MIN_MILLIS_AHEAD_TO_WRITE) >= bufferSizeMillis) {
            ...
            _ints.put(MIN_MILLIS_AHEAD_TO_WRITE, bufferSizeMillis);
        }
