...
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.REPEATING;
...
public class PFSeqPianoRollItem {
    ...
    public PFSeqPianoRollItem(PFSeqRunnable seq, PFSeqClip clip, String name, PFSeqTimeOffset timeOffset) {
        this.seq = seq;
        this.name = name;
