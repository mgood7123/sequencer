...
public class PFSeqTimeOffset {
    ...
    public static smallville7123.sequencer.sequencer.pfseq.PFSeqTimeOffset make(int beatOfBar, int mode, double percentPos, int binaryDivisions, int binaryPos, boolean isTriplet, int tripletPos) {
        if (mode == smallville7123.sequencer.sequencer.pfseq.PFSeqTimeOffset.MODE_FRACTIONAL) {
        ...
        if (mode == smallville7123.sequencer.sequencer.pfseq.PFSeqTimeOffset.MODE_PERCENT) {
            if (percentPos < 0 || percentPos > 1) {
                return null;
            }
        }

        smallville7123.sequencer.sequencer.pfseq.PFSeqTimeOffset timeOffset = new smallville7123.sequencer.sequencer.pfseq.PFSeqTimeOffset( beatOfBar,  mode,  percentPos,  binaryDivisions,  binaryPos,  isTriplet,  tripletPos);
    ...
    public double getPercent() {
        if (getMode() == smallville7123.sequencer.sequencer.pfseq.PFSeqTimeOffset.MODE_PERCENT) {
            return percent;
        } else {
