...
public class PFSeqLength {
    ...
    private smallville7123.sequencer.sequencer.pfseq.PFSeq seq;
    private PFSeqTimeOffset timeOffset;
    private int mode; // one of the PFSeqLength.MODE_ constants
    private long lengthAbsoluteNano;

    public PFSeqLength(smallville7123.sequencer.sequencer.pfseq.PFSeq seq, int mode, PFSeqTimeOffset timeOffset, long lengthAbsoluteNano) {
        this.seq = seq;
