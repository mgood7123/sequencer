package smallville7123.sequencer.sequencer.pfseq;
...
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.CONTROL_THREAD_POLLING_MILLIS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.FADE_LENGTH_FRAMES;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.FRAMES_TO_LEAVE_BEFORE_NEXT_ITEM;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.MAX_BPM;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.MAX_TRACKS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.MIN_BPM;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.MIN_MILLIS_AHEAD_TO_WRITE;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.MIN_WRITABLE_CONTENT_NANO;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.RUN_IN_FOREGROUND;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.SAMPLE_RATE;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.SMALLEST_STOPGAP_SILENCE_MILLIS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.SYNC_POLLING_SLEEP_MILLIS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.SYNC_TIME_OUT_MILLIS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.TEMPO;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.TIMESTAMP_POLLING_DELAY_MILLIS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqMessage.ALERT_MSG_PREFIX;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqMessage.ERROR_MSG_PREFIX;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqMessage.MESSAGE_TYPE_ALERT;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqMessage.MESSAGE_TYPE_ERROR;
