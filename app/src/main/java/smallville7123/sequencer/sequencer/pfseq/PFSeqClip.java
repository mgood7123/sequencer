...
import static smallville7123.sequencer.sequencer.pfseq.PFSeq.MICROS_PER_SECOND;
import static smallville7123.sequencer.sequencer.pfseq.PFSeq.NANO_PER_MICROS;
import static smallville7123.sequencer.sequencer.pfseq.PFSeqConfig.MAX_CLIP_FRAMES;
...
public class PFSeqClip {
    ...
    public PFSeqClip(PFSeqRunnable seq, File file) {
        this.file = file;
        this.seq = seq;
    ...
    public boolean load() {
        ...
        try {
            this.mediaFormat = smallville7123.sequencer.sequencer.pfseq.PFSeqAudio.getMediaFormat(file);
        } catch (Exception e) {
        ...
        try {
            this.pcm = smallville7123.sequencer.sequencer.pfseq.PFSeqAudio.getPcm(file);
        } catch (Exception e) {
